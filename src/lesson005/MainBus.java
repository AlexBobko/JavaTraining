...
public class MainBus {
	public static void main(String[] args) {
		...
		menu: while (true) {
			...
			case "0": {
				System.out.println("0 вывести весь список");
				System.out.println(busesPark.toString());
				break;
			}
			case "1": {
				...
				if (selectBusToRout == 0) {
					...
					System.out.print(busesPark.getBusToRout(selectBusToRout));
				}
				break;
			}
			...
			case "3": {
				...
				if (selectExpirationMileage == 0) {
					...
					System.out.print(busesPark.getExpirationDate(selectExpirationMileage));
					//System.out.print(selectExpirationMileage);
				}
				break;
			}
			default: {
	...
	private static String startMenu() {
		...
		System.out.println("2 - Задать срок эксплуатации и вывести список автобусов эксплуатирующихся больше заданного.");
