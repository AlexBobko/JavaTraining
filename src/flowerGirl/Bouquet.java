...
public class Bouquet {
	...
	//private Map<Accessory, Integer> accessories = new TreeMap<Accessory, Integer>();;
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((formBouquet == null) ? 0 : formBouquet.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (formBouquet != other.formBouquet)
			return false;
		if (Float.floatToIntBits(priceBouquet) != Float
				.floatToIntBits(other.priceBouquet))
			return false;
		return true;
	}
